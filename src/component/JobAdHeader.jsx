...
import header from "../assets/default-companyHeader.jpeg"
import logo from "../assets/default-companyLogo.jpg"
import {BsHeart} from "react-icons/bs"
import {HiOutlineShare} from "react-icons/hi"
import {SlArrowLeft} from "react-icons/sl"
const JobAdHeader = () => {
    return <div className="ad-header-container">
...
<span className="ad-age">
  (5 روز پیش)
</span>
            </div>
            <div className="icons-container">
              <a href=""><HiOutlineShare className="share-icon"></HiOutlineShare></a>
              <a href=""><BsHeart className="like-icon"></BsHeart></a>
            </div>
          </div>
          <div className="row1-content-row">
          ...
          <div className="row1-content-row">
            ...
            <span className="cooperation-type">
              تمام وقت
            </span>
          </div>
        </div>
...
<p>
شنبه تا چهارشنبه 9 الی 17:15-پنجشنبه ها 9 الی 13:15
</p>
</div>
<div>
<span>
...
<div className="sticky-job-header">
  <div className="sticky-icons-container">
    ...
    <a href=""><HiOutlineShare></HiOutlineShare></a>
  </div>
  ...
  <div className="sticky-back-button-container">
     <a href=""><SlArrowLeft></SlArrowLeft></a>
  </div>
</div>
    </div>;
  };
